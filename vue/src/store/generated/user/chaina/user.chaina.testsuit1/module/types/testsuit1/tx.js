...
export class MsgClientImpl {
    ...
    SendIbcDataInfo(request) {
        ...
        const promise = this.rpc.request("user.chaina.testsuit1.Msg", "SendIbcDataInfo", data);
    ...
    CreateDataInfo(request) {
        ...
        const promise = this.rpc.request("user.chaina.testsuit1.Msg", "CreateDataInfo", data);
    ...
    UpdateDataInfo(request) {
        ...
        const promise = this.rpc.request("user.chaina.testsuit1.Msg", "UpdateDataInfo", data);
    ...
    DeleteDataInfo(request) {
        ...
        const promise = this.rpc.request("user.chaina.testsuit1.Msg", "DeleteDataInfo", data);
