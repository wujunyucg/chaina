...
import UserChainaUserChainaTestsuit1 from './user/chaina/user.chaina.testsuit1'
...
export default { 
  UserChainaUserChainaTestsuit1: load(UserChainaUserChainaTestsuit1, 'user.chaina.testsuit1'),
